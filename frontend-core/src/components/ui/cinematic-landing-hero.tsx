...
export function CinematicHero({ 
  brandName = "SuperApp",
  tagline1 = "Everything you need,",
  tagline2 = "all in one place.",
  cardHeading = "The Future of Social.",
  cardDescription = <><span className="text-white font-semibold">SuperApp</span> combines social feeds, marketplace, dating, ride-hailing, food delivery, and AI — all powered by a master algorithm that learns what you love.</>,
  metricValue = 1000000,
  metricLabel = "Active Users",
  ctaHeading = "Download SuperApp.",
  ctaDescription = "Join millions already living smarter. One app. Infinite possibilities.",
  className, 
  ...props 
}: CinematicHeroProps) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      scrollTl
        ...
        .to(".counter-val", { innerHTML: metricValue > 999999 ? "1M+" : metricValue, snap: { innerHTML: 1 }, duration: 2, ease: "expo.out" }, "-=2.0")
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          ...
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">SuperApp</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">SA</div>
                      </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Trending Now</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">10K+ views today</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">New Match</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">3 people nearby</p>
                  </div>
                </div>
              </div>
            </div>
