...
import { Eye, EyeOff, Zap, Mail, Lock, QrCode } from 'lucide-react'
      ...
      <div className="relative w-full max-w-md rounded-3xl border border-slate-700/60 bg-slate-900/80 p-7 shadow-[0_20px_80px_-35px_rgba(56,189,248,0.45)] backdrop-blur-xl sm:p-8">
        ...
        <div className="mb-7">
          <div className="mb-4 flex justify-center">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-400 via-blue-500 to-indigo-600 shadow-lg shadow-cyan-900/40">
              <Zap size={28} className="text-white" />
            </div>
          </div>
          <p className="mb-1.5 text-center text-[11px] font-semibold uppercase tracking-[0.18em] text-cyan-300/90">Welcome Back</p>
          <h1 className="text-center text-3xl font-black tracking-tight text-white">Sign in to SuperApp</h1>
          <p className="mt-2 text-center text-sm text-slate-400">Your chats, rides, food, and more — all in one place.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-600/80 bg-slate-800/80 pl-10 pr-3.5 py-3 text-sm text-white placeholder:text-slate-500 outline-none transition focus:border-cyan-400/80 focus:ring-2 focus:ring-cyan-400/20"
                value={email}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-600/80 bg-slate-800/80 pl-10 pr-11 py-3 text-sm text-white placeholder:text-slate-500 outline-none transition focus:border-cyan-400/80 focus:ring-2 focus:ring-cyan-400/20"
                value={password}
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-1 w-full rounded-xl bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-500 py-3.5 font-bold text-white shadow-lg shadow-cyan-900/40 transition hover:brightness-110 active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed"
          >
