...
export const Component = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 shadow-md w-full max-w-sm">
      <span className="font-semibold text-base text-gray-900 dark:text-white">Comments</span>
        ...
        <div className="flex flex-col gap-2 flex-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <span className="text-sm font-medium text-gray-900 dark:text-white">Yassine Zanina</span>
              <p className="text-xs text-gray-400">Wednesday, March 13th at 2:45pm</p>
            </div>
          </div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            intuitive and easy to use, and the features are exactly what I need to streamline my workflow.
          </p>
        </div>
      </div>
      ...
      {/* Reply text box */}
      <div className="mt-4">
        <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-2 bg-gray-50 dark:bg-gray-800">
          <textarea
            placeholder="Reply"
            className={cn(
              "w-full bg-transparent text-sm text-gray-900 dark:text-white placeholder:text-gray-400",
              "resize-none outline-none min-h-[60px] px-1",
            )}
          />
          <div className="flex items-center gap-1 mt-1">
            ...
            <button
              ...
              aria-label="Send"
              title="Send"
              className="ml-auto p-1.5 rounded-lg bg-blue-500 hover:bg-blue-600 transition-colors"
            >
